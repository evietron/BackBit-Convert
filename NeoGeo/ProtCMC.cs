// Contains parts from
// https://raw.githubusercontent.com/mamedev/mame/master/src/devices/bus/neogeo/prot_cmc.cpp
// license:BSD-3-Clause
// copyright-holders:S. Smith,David Haywood,Fabio Priuli

using System;

public class ProtCMC
{
    static readonly byte[] kof99_type0_t03 =
    {
    ...
    static readonly byte[] kof99_type0_t12 =
    {
    ...
    static readonly byte[] kof99_type1_t03 =
    {
    ...
    static readonly byte[] kof99_type1_t12 =
    {
    ...
    static readonly byte[] kof99_address_8_15_xor1 =
    {
    ...
    static readonly byte[] kof99_address_8_15_xor2 =
    {
    ...
    static readonly byte[] kof99_address_16_23_xor1 =
    {
    ...
    static readonly byte[] kof99_address_16_23_xor2 =
    {
    ...
    static readonly byte[] kof99_address_0_7_xor =
    {
    ...
    static readonly byte[] kof2000_type0_t03 =
    {
    ...
    static readonly byte[] kof2000_type0_t12 =
    {
    ...
    static readonly byte[] kof2000_type1_t03 =
    {
    ...
    static readonly byte[] kof2000_type1_t12 =
    {
    ...
    static readonly byte[] kof2000_address_8_15_xor1 =
    {
    ...
    static readonly byte[] kof2000_address_8_15_xor2 =
    {
    ...
    static readonly byte[] kof2000_address_16_23_xor1 =
    {
    ...
    static readonly byte[] kof2000_address_16_23_xor2 =
    {
    ...
    static readonly byte[] kof2000_address_0_7_xor =
    {
    ...
    static void Decrypt(out byte r0, out byte r1, byte c0, byte c1, byte[] table0hi, byte[] table0lo, byte[] table1, int baseAddr, bool invert, bool cmc50)
    {
        byte tmp = table1[(baseAddr & 0xff) ^ (cmc50 ? kof2000_address_0_7_xor : kof99_address_0_7_xor)[(baseAddr >> 8) & 0xff]];
        byte xor0 = (byte)((table0hi[(baseAddr >> 8) & 0xff] & 0xfe) | (tmp & 0x01));
        byte xor1 = (byte)((tmp & 0xfe) | (table0lo[(baseAddr >> 8) & 0xff] & 0x01));
    ...
    public static void GfxDecrypt(byte[] rom, int extraXor, bool cmc50)
    {
        byte[] buf = new byte[rom.Length];

        for (int rpos = 0; rpos < rom.Length / 4; rpos++)
        {
            Decrypt(out buf[4 * rpos + 0], out buf[4 * rpos + 3], rom[4 * rpos + 0], rom[4 * rpos + 3],
                cmc50 ? kof2000_type0_t03 : kof99_type0_t03,
                cmc50 ? kof2000_type0_t12 : kof99_type0_t12,
                cmc50 ? kof2000_type1_t03 : kof99_type1_t03,
                rpos,
                ((rpos >> 8) & 1) != 0,
                cmc50);
            Decrypt(out buf[4 * rpos + 1], out buf[4 * rpos + 2], rom[4 * rpos + 1], rom[4 * rpos + 2],
                cmc50 ? kof2000_type0_t12 : kof99_type0_t12,
                cmc50 ? kof2000_type0_t03 : kof99_type0_t03,
                cmc50 ? kof2000_type1_t12 : kof99_type1_t12,
                rpos,
                (((rpos >> 16) ^ (cmc50 ? kof2000_address_16_23_xor2 : kof99_address_16_23_xor2)[(rpos >> 8) & 0xff]) & 1) != 0,
                cmc50);
        }
        ...
        for (int rpos = 0; rpos < rom.Length / 4; rpos++)
        {
            ...
            baser ^= (cmc50 ? kof2000_address_8_15_xor1 : kof99_address_8_15_xor1)[(baser >> 16) & 0xff] << 8;
            baser ^= (cmc50 ? kof2000_address_8_15_xor2 : kof99_address_8_15_xor2)[baser & 0xff] << 8;
            baser ^= (cmc50 ? kof2000_address_16_23_xor1 : kof99_address_16_23_xor1)[baser & 0xff] << 16;
            baser ^= (cmc50 ? kof2000_address_16_23_xor2 : kof99_address_16_23_xor2)[(baser >> 8) & 0xff] << 16;
            baser ^= (cmc50 ? kof2000_address_0_7_xor : kof99_address_0_7_xor)[(baser >> 8) & 0xff];

            if (rom.Length == 0x3000000) /* special handling for preisle2 */
            {
                if (rpos < 0x2000000 / 4)
                {
                    baser &= (0x2000000 / 4) - 1;
            ...
            else if (rom.Length == 0x6000000) /* special handling for kf2k3pcb */
            {
                if (rpos < 0x4000000 / 4)
                {
                    baser &= (0x4000000 / 4) - 1;
    ...
    public static void SFixDecrypt(byte[] rom, byte[] fix)
    {
        for (int i = 0; i < fix.Length; i++) {
            fix[i] = rom[rom.Length - fix.Length + (i & ~0x1f) + ((i & 7) << 2) + ((~i & 8) >> 2) + ((i & 0x10) >> 4)];
        }
    }


    static readonly byte[] m1_address_8_15_xor =
    {
    ...
    static readonly byte[] m1_address_0_7_xor =
    {
    ...
    static int M1AddressScramble(int address, ushort key)
    {
    ...
    public static void M1Decrypt(byte[] rom)
    {
        byte[] buf = new byte[rom.Length];
    ...
    public static byte[] SBPDecrypt(byte[] rom)
    {
    ...
    public static void VoiceDecrypt(byte[] rom, int val)
    {
        byte[] buf = new byte[rom.Length];
        Buffer.BlockCopy(rom, 0, buf, 0, rom.Length);
    ...
    public static byte[] KOF98Decrypt(byte[] rom)
    {
